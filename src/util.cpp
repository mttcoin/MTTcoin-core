...
const char * const BITCOIN_CONF_FILENAME = "MTTcoin.conf";
const char * const BITCOIN_PID_FILENAME = "MTTcoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "MTTcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/MTTcoin";
#else
    // Unix
    return pathRet / ".MTTcoin";
#endif
#endif
}
