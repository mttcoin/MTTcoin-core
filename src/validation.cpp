...
#if defined(NDEBUG)
# error "MTTcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "MTTcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s MTT additional fees, %d delta bytes\n",
