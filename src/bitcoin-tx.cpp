...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s MTTcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  MTTcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded MTTcoin transaction") + "\n" +
              "  MTTcoin-tx [options] -create [commands]   " + _("Create hex-encoded MTTcoin transaction") + "\n" +
              "\n";
